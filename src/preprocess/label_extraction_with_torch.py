...
class LoadData:
    ...
    def extract_labels():
        ...
        torch.save(result, "C:\\work\\routine_projects\\NetworkFirst\\dataset\\labels\\extracted")
    ...
    def extract_images(directory_in_str):
        ...
        torch.save(dir_of_images, "C:\\work\\routine_projects\\NetworkFirst\\dataset\labels\trash")
